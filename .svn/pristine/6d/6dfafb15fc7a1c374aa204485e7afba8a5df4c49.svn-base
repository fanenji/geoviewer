    ...
    launch: function() {
        ...
        var config = {
            "application": {
                ...
                "layout": {
                    "header": {
                        "html": "<div><table><tr><td><img src='img/headerSfondoBdil.png' ></td><td>&nbsp;&nbsp;</td><td id='headerSfondo2' style='vertical-align: middle; '><div id='titolo' >Cartogrammi Statistici</div></td></tr></table></div>",
                        "height": 150,
